...
def doesCancel(a, b):
    ...
    if aFirst == bLast:  # Check if digits even cancel at all.
        return aLast / bFirst == a / b  # Check if they cancel in this misleading way
    elif aLast == bFirst:  # Check if digits even cancel at all.
        return aFirst / bLast == a / b  # Check if they cancel in this misleading way
    return False
...
# We'll factor this in lowest terms. We know the factors all have to be less than 100,
# so we can just multiply and check with brute force.
# This process is a little cumbersome, but not too bad. It could be avoided by importing
# the "fractions" package in python.
